package br.com.drianodev.cachespring;
...
public class CacheSpringApplication {
	...
	ApplicationRunner runner(ProductService productService) {
		return args -> {
			...
			System.out.println("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
			System.out.println("Id: 1: " + productService.getByIdWithCache(1L));
			System.out.println("Id: 2: " + productService.getByIdWithCache(2L));
			System.out.println("Id: 1: " + productService.getByIdWithCache(1L));
			System.out.println("Id: 1: " + productService.getByIdWithCache(1L));
			System.out.println("Id: 1: " + productService.getByIdWithCache(1L));
		};
